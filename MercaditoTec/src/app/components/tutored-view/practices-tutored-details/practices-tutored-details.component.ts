...
@Component({
  selector: 'app-practices-tutored-details',
  templateUrl: './practices-tutored-details.component.html',
  styleUrls: ['./practices-tutored-details.component.scss']
})
export class PracticesTutoredDetailsComponent implements OnInit {
