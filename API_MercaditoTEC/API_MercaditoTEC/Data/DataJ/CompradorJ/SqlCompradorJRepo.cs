...
namespace API_MercaditoTEC.Data.DataJ
{
    public class SqlCompradorJRepo : ICompradorJRepo
    {
        ...
        private readonly ICompradorRepo _compradorRepo;
        private readonly IPersonaRepo _personaRepo;
        private readonly IEstudianteJRepo _estudianteJRepo;
        private readonly IMapper _mapper;

        public SqlCompradorJRepo(MercaditoTECContext context, ICompradorRepo compradorRepo, IPersonaRepo personaRepo, IEstudianteJRepo estudianteJRepo,
            IMapper mapper)
        {
            _context = context;
